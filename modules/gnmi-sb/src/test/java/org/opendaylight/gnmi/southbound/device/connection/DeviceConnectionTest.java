...
class DeviceConnectionTest {
    ...
    public void closesListenerBeforeSessionProviderTest() throws Exception {
        ...
        final var inOrder = Mockito.inOrder(connectionStatusListenerMock, sessionProviderMock);
     ...
     * (otherwise the gRPC channel leaks); the listener's exception is logged rather than rethrown,
     * since the caller only logs it anyway.
     */
    @Test
