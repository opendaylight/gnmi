...
public class GnmiSouthboundProvider implements AutoCloseable {
    ...
    private void initGnmiTopology() throws ExecutionException, InterruptedException, TimeoutException {
        ...
        configTx.merge(LogicalDatastoreType.CONFIGURATION, IdentifierUtils.GNMI_TOPO_ID, topology);
        ...
        operTx.merge(LogicalDatastoreType.OPERATIONAL, IdentifierUtils.GNMI_TOPO_ID, topology);
