 ...
 */
package org.opendaylight.gnmi.southbound.identifier;
...
public final class IdentifierUtils {
    ...
    public static final DataObjectIdentifier<Topology> GNMI_TOPOLOGY_PATH = DataObjectIdentifier
        .builder(NetworkTopology.class)
        .child(Topology.class, new TopologyKey(new TopologyId(GNMI_TOPOLOGY_ID)))
        .build();
    public static final DataObjectReference<Node> GNMI_NODE_DTI = GNMI_TOPOLOGY_PATH.toBuilder()
        .toReferenceBuilder()
        .child(Node.class)
        .build();
    ...
    public static DataObjectIdentifier<Node> gnmiNodeID(final NodeId nodeId) {
        return GNMI_TOPOLOGY_PATH.toBuilder().child(Node.class, new NodeKey(nodeId)).build();
    }
}
