...
public class KeystoreGnmiSecurityProvider implements GnmiSecurityProvider {
    ...
    private static KeyPair getKeyPair(String passphrase, Object obj, JcaPEMKeyConverter converter,
            PEMDecryptorProvider pemDecProv, Provider bcprov) throws IOException {
        switch (obj) {
